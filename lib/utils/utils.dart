...
class Utils {
  ...
  static String timeAgoSinceDate(int milliSecond) {
    ...
    final duration =
        Duration(days: date.day, hours: date.hour, minutes: date.minute, seconds: date.second);
    ...
    } else if ((difference.inDays / daysInMonth(monthNum: date.month, year: date.year)).floor() >=
        1) {
