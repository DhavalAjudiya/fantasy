...
// import 'package:fantasyarenas/utils/scaleup_animation.dart';
...
// }
//
// class _OldHomePageState extends State<OldHomePage> with SingleTickerProviderStateMixin {
//   Timer? timer;
//   Timer? timerB;
//   int _currentPage = 0;
//   int _currentPageB = 0;
...
//
//   backPosterTimer() {
//     timerB = Timer.periodic(const Duration(seconds: 4), (Timer timer) {
//       homeController.isBackPosterShadow.value = false;
//
//       if (homeController.isBackPosterReverse.value) {
//         if (_currentPageB > 0) {
//           Future.delayed(const Duration(seconds: 1), () {
//             homeController.isBackPosterShadow.value = true;
//           });
//           _currentPageB--;
//         } else {
...
//                         boxShadow: [
//                           BoxShadow(
//                               color: homeController.isBackPosterShadow.value
